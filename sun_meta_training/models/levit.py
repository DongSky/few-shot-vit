...
model_cfgs = dict(
    ...
    levit_384=dict(
        embed_dim=(256, 384, 512), key_dim=32, num_heads=(4, 6, 8), depth=(1, 2, 3)),
    levit_384s=dict(
...
class Levit(nn.Module):
    ...
    def __init__(
        ...
        self.patch_embed = ConvBlock(in_chans, 64, embed_dim[0])#hybrid_backbone or stem_b16(in_chans, embed_dim[0], activation=act_layer)
